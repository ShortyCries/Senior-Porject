    ...
    <div class="modal fade" id="viewusermodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form method="POST" action="update-profile-picture-player.php" enctype="multipart/form-data">
  ...
  <script>
    $(document).ready(function() {
      $('#passwordForm').submit(function(event) {
        ...
        $.ajax({
          method: "POST",
          url: 'update-player-password.php', // Update the URL to your server-side script
          data: {

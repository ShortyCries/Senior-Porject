...
$query = "SELECT name, email, DOB, status FROM player NATURAL JOIN login where type = 'player'";
                    ...
                    <table>
                        ...
                        <?php
                                for ($i = 0; $i < $r; $i++) {
                                    ...
                                    echo "<td>  $row[2] </td> ";
                                    if($row[3] == 'active'){
                                        echo "<td><span class=\"status return\"> <a style=\"text-decoration: none; color: white;\" href='admin-Players.php?email={$row[1]}&status=deactive'  > Deactivate </a> </span> </td> ";
    
                                        } else {
                                            echo "<td><span class=\"status delivered\"> <a style=\"text-decoration: none; color: white;\" href='admin-Players.php?email={$row[1]}&status=active'  > Activate </a> </span> </td> ";
                                        }
                                    echo "</tr>";
                                }
                                ?>                      

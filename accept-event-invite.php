...
try {
    ...
    if (isset($_POST['eventID'])) {
        ...
        $query = "UPDATE participate SET PRstatus = 'accepted' WHERE PReventid = '$eventID' AND PRplayeremail = '$playerEmail'";

        $result = $pdo->exec($query);



        $_SESSION['status'] = "Event joined!";
        header("location:player-games.php");

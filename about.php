		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 info-left">
					<img class="img-fluid" src="img/d3c6a4f5-1690-4565-83a8-8288482171b9.jpg" alt="">
				</div>
				<div class="col-lg-6 info-right">
					<h6>We are humble and hardworking engineers looking to make a diffrence in the world</h6>
					<h1></h1>
					<p></p>
				</div>
			</div>

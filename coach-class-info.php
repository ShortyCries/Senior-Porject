            ...
            <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1">
                ...
                <div class="u-custom-menu u-nav-container">
                    <ul class="u-nav u-unstyled u-nav-1">
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="coachPage.php" style="padding: 10px 20px;">Home</a>
                        </li>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td> <a href="#" type="button" class="btn btn-success add_report">
                        Add Report
                    </a></td>
            </tr>
    </tbody>
...
<div class="modal fade" id="Fill_Report_Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Fill Report</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="add-report-info.php" method="post">
                <div class="modal-body">

                

                <input type="hidden" name="P-EMAIL" id="THEPLAYEREMAIL">
                <input type="hidden" name="CLASS-ID" id="THECLASSID">
                Report:
                <textarea name="description" style="height: 150px;" type="text" class="form-control"></textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('.add_report').click(function(e) {
            ...
            $('#THEPLAYEREMAIL').val(playerEmail);
            $('#THECLASSID').val(classID);


            $('#Fill_Report_Modal').modal('show');
